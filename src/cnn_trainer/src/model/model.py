...
def load_model():
    return models.load_model(os.path.join(PATH, 'src', 'model', 'my_model'))
...
def get_model(X_dataset, Y_dataset, print_summary=False, new=False):  
...
def main():
    ...
    conv_model = get_model(X_dataset, Y_dataset, new=True)
